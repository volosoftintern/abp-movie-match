...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieMatch.Genres.Genre", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieMatch.Movies.MovieDetail", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppMovieDetails", (string)null);
                });

            modelBuilder.Entity("MovieMatch.Movies.MovieGenre", b =>
                {
                    ...
                    b.HasKey("MovieDetailId", "GenreId");

                    b.HasIndex("GenreId");

                    b.HasIndex("MovieDetailId", "GenreId");

                    b.ToTable("AppMovieGenres", (string)null);
                });

            modelBuilder.Entity("MovieMatch.Movies.MoviePerson", b =>
                {
                    b.Property<int>("MovieDetailId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("MovieDetailId", "PersonId");

                    b.HasIndex("PersonId");

                    b.HasIndex("MovieDetailId", "PersonId");

                    b.ToTable("AppMoviePeople", (string)null);
                });
            ...
            modelBuilder.Entity("MovieMatch.People.Director", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieMatch.People.Person", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieMatch.Movies.MovieDetail", b =>
                {
                    b.HasOne("MovieMatch.People.Director", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MovieMatch.Movies.MovieGenre", b =>
                {
                    b.HasOne("MovieMatch.Genres.Genre", null)
                        .WithMany()
                        .HasForeignKey("GenreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MovieMatch.Movies.MovieDetail", null)
                        .WithMany("Genres")
            ...
            modelBuilder.Entity("MovieMatch.Movies.MoviePerson", b =>
                {
                    ...
                    b.HasOne("MovieMatch.People.Person", null)
                        .WithMany()
