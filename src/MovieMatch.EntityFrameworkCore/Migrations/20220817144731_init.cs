    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMovieDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppMovieDetails_AppDirectors_DirectorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppPosts_AppMovies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "AppMovies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMovieGenres", x => new { x.MovieDetailId, x.GenreId });
                    table.ForeignKey(
                        name: "FK_AppMovieGenres_AppGenres_GenreId",
                        column: x => x.GenreId,
                        principalTable: "AppGenres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppMovieGenres_AppMovieDetails_MovieDetailId",
                        column: x => x.MovieDetailId,
                        principalTable: "AppMovieDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMoviePeople", x => new { x.MovieDetailId, x.PersonId });
                    table.ForeignKey(
                        name: "FK_AppMoviePeople_AppMovieDetails_MovieDetailId",
                        column: x => x.MovieDetailId,
                        principalTable: "AppMovieDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppMoviePeople_AppPeople_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppMovieDetails_DirectorId",
                table: "AppMovieDetails",
                column: "DirectorId");

            migrationBuilder.CreateIndex(
                name: "IX_AppMovieDetails_Id",
                table: "AppMovieDetails",
                column: "Id");

            migrationBuilder.CreateIndex(
                name: "IX_AppMovieGenres_GenreId",
                table: "AppMovieGenres",
                column: "GenreId");

            migrationBuilder.CreateIndex(
                name: "IX_AppMovieGenres_MovieDetailId_GenreId",
                table: "AppMovieGenres",
                columns: new[] { "MovieDetailId", "GenreId" });

            migrationBuilder.CreateIndex(
                name: "IX_AppMoviePeople_MovieDetailId_PersonId",
                table: "AppMoviePeople",
                columns: new[] { "MovieDetailId", "PersonId" });

            migrationBuilder.CreateIndex(
                name: "IX_AppMoviePeople_PersonId",
                table: "AppMoviePeople",
                column: "PersonId");
