...
{
    public MovieMatch.Rating.IRatingPublicAppService RatingPublicAppService { get; }
    public AbpMvcUiOptions AbpMvcUiOptions { get; }
    public ICurrentUser CurrentUser { get; }

    public RatingViewComponent(MovieMatch.Rating.IRatingPublicAppService ratingPublicAppService, IOptions<AbpMvcUiOptions> options, ICurrentUser currentUser)
    {
    ...
    public virtual async Task<IViewComponentResult> InvokeAsync(string entityType, string entityId)
    {
        ...
        return View("~/Components/Rating/Default.cshtml", viewModel);
    }
}
